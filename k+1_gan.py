...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="train_k+1_gan")
    parser.add_argument('--root', type=str, default="./improvedGAN")
    ...
    root = args_.root
    save_img_dir = os.path.join(root, "imgs_improved_celeba_gan")
    save_model_dir= root
    ...
    log_path = os.path.join(root, "attack_logs")
    ...
    model_name_T = args_.model_name_T
